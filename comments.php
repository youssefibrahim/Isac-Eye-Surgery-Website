...
<p><?php _e("You must be",'health'); ?> <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php echo urlencode(get_permalink()); ?>"><?php _e("logged in",'health'); ?></a> <?php _e("to post a comment",'health'); ?></p>
<?php else : ?>
<div class="hc_comment_form_section">
  <?php  
    $fields=array(
    'author' => '<div class="hc_form_group"><label>'.__('Name','health'),'<small>*</small></label><input class="hc_con_input_control" name="author" id="author" value="" type="text"/></div>',
    'email' => '<div class="hc_form_group"><label>'.__('Email','health'),'<small>*<small></label><input class="hc_con_input_control" name="email" id="email" value=""   type="email" ></div>',
    'website' => '<div class="hc_form_group"><label>'.__('Website','health'),'</label><input class="hc_con_input_control" name="website" id="website" value=""   type="text" ><br/></div>',
    );
