			...
			<div class="col-md-3 hc_home_portfolio_area">
				...
				<div class="hc_home_portfolio_showcase">
					...
					<?php if($current_options['project_one_thumb']) { ?>
					  ...
					  <img alt="First Thumb" class="hc_img_responsive" src="<?php echo $current_options['project_one_thumb']; ?>"></a>
					  <?php } ?>
					</div>
				</div>
				<?php } ?>
			...
			<div class="col-md-3 hc_home_portfolio_area">
				...
				<div class="hc_home_portfolio_showcase">
					...
					<?php if($current_options['project_two_thumb']) { ?>
					  ...
					  <img alt="Second Thumb" class="hc_img_responsive" src="<?php echo $current_options['project_two_thumb']; ?>"></a>
					  <?php } ?>
					</div>
				</div>
				<?php } ?>
			...
			<div class="col-md-3 hc_home_portfolio_area">
				...
				<div class="hc_home_portfolio_showcase">
					...
					<?php if($current_options['project_three_thumb']) { ?>
					  ...
					  <img alt="Third Thumb" class="hc_img_responsive" src="<?php echo $current_options['project_three_thumb']; ?>"></a>
					  <?php } ?>
					</div>
				</div>
				<?php } ?>
			...
			<div class="col-md-3 hc_home_portfolio_area">
				...
				<div class="hc_home_portfolio_showcase">
					...
					<?php if($current_options['project_four_thumb']) { ?>
					  ...
					  <img alt="Fourth Thumb" class="hc_img_responsive" src="<?php echo $current_options['project_four_thumb']; ?>"></a>
					  <?php } ?>
					</div>
				</div>
				<?php } ?>
